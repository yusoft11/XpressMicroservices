...
{
    [Route("api/authproduct")]
    [ApiController]
    public class AuthProdController : ControllerBase
    {
        private IConfiguration _config;
        private readonly ILogger<AuthProdController> _logger;
        public AuthProdController(IConfiguration config, ILogger<AuthProdController> logger)
        {
            _config = config;
            _logger = logger;
        }
